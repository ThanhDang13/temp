...
import realm.packages.vertx.core.config.vertx.exeception.http.DefaultExceptionResolver;
import realm.packages.vertx.core.config.vertx.exeception.http.DefaultFilterExceptionResolver;
...
public class VertxRestApi {
    ...
    public VertxRestApi webControllerResultResolver(ControllerResultResolver controllerResultResolver) {
