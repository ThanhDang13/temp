...
public class DefaultJackson {
  ...
  public static final PropertyNamingStrategy.SnakeCaseStrategy SNAKE_CASE =
      new PropertyNamingStrategy.SnakeCaseStrategy();
  private static ObjectMapper objectMapper;

  @Autowired private MappingJackson2HttpMessageConverter springMvcJacksonConverter;
  ...
  public static Object readObjectDfNull(ObjectMapper objectMapper, String body, Class clazz)
