...
public class JWTService {
  ...
  public VertxPrincipal extractPrincipal(String token, HttpServerRequest request) {
    try {
      ...
      SimpleSecurityUser user =
          DefaultJackson.objectMapper().readValue(userString, SimpleSecurityUser.class);
      ...
      return SimplePrincipal.builder().clientInfo(request.headers()).build();
    }
  }
